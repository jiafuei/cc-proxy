...
class CacheBreakpointTransformer(ProviderRequestTransformer):
...
class ClaudeSystemMessageCleanerTransformer(ProviderRequestTransformer):
...
class ClaudeSoftwareEngineeringSystemMessageTransformer(ProviderRequestTransformer):
