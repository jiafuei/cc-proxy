...
@pytest.mark.parametrize("test_scenario,request_params,expected_routing", [
    ...
    ("plan mode string content", 
     {'messages': [{'role': 'user', 'content': '<system-reminder>\nPlan mode is active. Build a new feature'}]}, 
     'planning'),
    ("plan mode list content", 
     {'messages': [{'role': 'user', 'content': [{'type': 'text', 'text': '<system-reminder>\nPlan mode is active.'}]}]}, 
     'planning'),
    ("plan mode only last user message", 
     {'messages': [{'role': 'user', 'content': 'Normal message'}, {'role': 'assistant', 'content': 'Response'}, {'role': 'user', 'content': '<system-reminder>\nPlan mode is active.'}]}, 
     'planning'),
    ...
    # Thinking scenarios
    ("thinking routing", 
     {'thinking': {'type': 'enabled', 'budget_tokens': 1000}, 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'thinking'),
    ("thinking zero budget ignored", 
     {'thinking': {'type': 'enabled', 'budget_tokens': 0}, 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'default'),
    ("plan and think combined", 
     {'thinking': {'type': 'enabled', 'budget_tokens': 500}, 'messages': [{'role': 'user', 'content': '<system-reminder>\nPlan mode is active.'}]}, 
     'plan_and_think'),
    ("thinking priority over planning", 
     {'thinking': {'type': 'enabled', 'budget_tokens': 1000}, 'messages': [{'role': 'user', 'content': '<system-reminder>\nPlan mode is active.'}]}, 
     'plan_and_think'),
    # Agent routing scenarios  
    ("agent routing string system", 
     {'system': '/model test_agent', 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'default'),
    ("agent routing list system", 
     {'system': [{'type': 'text', 'text': '/model another_agent\nSome instructions follow'}], 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'default'),
    ...
    ("builtin tools detection", 
     {'tools': [{'type': 'web_search', 'name': 'WebSearch'}, {'name': 'custom', 'description': 'A custom tool', 'input_schema': {'type': 'object', 'properties': {}}}], 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'builtin_tools'),
    ("builtin tools websearch webfetch", 
     {'tools': [{'type': 'web_search', 'name': 'WebSearch'}, {'type': 'web_fetch', 'name': 'WebFetch'}], 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'builtin_tools'),
    ("builtin tools vs regular tools", 
     {'tools': [{'name': 'custom_tool', 'description': 'A custom tool', 'input_schema': {'type': 'object', 'properties': {}}}], 'messages': [{'role': 'user', 'content': 'Test'}]}, 
     'default'),
